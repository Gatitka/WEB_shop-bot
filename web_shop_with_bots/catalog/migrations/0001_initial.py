    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.CharField(db_index=True, help_text="Добавьте артикул, прим. '0101'.", max_length=6, primary_key=True, serialize=False, unique=True, verbose_name='артикул')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('messenger_name', models.CharField(blank=True, db_index=True, max_length=200, null=True, verbose_name='мсдж_название')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('language_code', models.CharField(db_index=True, max_length=15, verbose_name='Language')),
                ('short_name', models.CharField(blank=True, db_index=True, help_text='Добавьте название блюда.', max_length=200, null=True, verbose_name='короткое описание')),
                ('text', models.CharField(blank=True, help_text='Добавьте описание блюда.', max_length=200, null=True, verbose_name='полное описание')),
                ('msngr_short_name', models.CharField(blank=True, db_index=True, help_text='Добавьте название блюда.', max_length=200, null=True, verbose_name='мсдж_короткое описание')),
