    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(blank=True, max_length=100, null=True, validators=[django.core.validators.MinLengthValidator(8)], verbose_name='Пароль')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lat', models.CharField(blank=True, help_text='прим. "44.809000122132566".', max_length=60, null=True, verbose_name='координаты ШИР (lat)')),
                ('lon', models.CharField(blank=True, help_text='прим. "20.458040962192968".', max_length=60, null=True, verbose_name='координаты ДОЛ (lon)')),
